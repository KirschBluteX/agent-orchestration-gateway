#!/usr/bin/env python3
"""Shared in-process deadlines for synchronous AOG Hook work."""
...
_DEADLINE: ContextVar[float | None] = ContextVar("aog_operation_deadline", default=None)
...
def remaining_seconds(*, reserve: float = 0.0) -> float | None:
    ...
    if remaining <= 0:
        raise OperationDeadlineExceeded("AOG internal Hook deadline exceeded")
    return remaining
