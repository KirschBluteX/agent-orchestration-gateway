#!/usr/bin/env python3
"""Pure compiler for the canonical CCO delegation request.
...
DELEGATION_REQUEST_PROTOCOL = "cco.delegation.v1"
DELEGATION_COMPILATION_PROTOCOL = "cco.delegation-compile.v1"
PLANNER_PROPOSAL_PROTOCOL = "cco.planner-proposal.v1"
...
def derive_assurance(node: Mapping[str, Any]) -> str:
    """Apply the only assurance ladder used by CCO's compiler and router."""
