...
class ProjectContractTests(unittest.TestCase):
    def test_public_identity_and_bilingual_entrypoints(self) -> None:
        ...
        self.assertRegex(manifest["version"], r"^4\.0\.5\+codex\.[a-z0-9.-]+$")
    ...
    def test_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('PLUGIN_VERSION = "4.0.5"', installer)
        self.assertRegex(manifest["version"], r"^4\.0\.5\+")
        self.assertRegex(changelog, r"(?m)^## 4\.0\.5 - ")
